...
const FAMILY_RELATIONS = [
  ...
  { value: 'قريبة', label: '👤 قريبة' },
  
  // علاقات خاصة
  { value: 'متبنى', label: '👦 متبنى' },
  { value: 'متبناة', label: '👧 متبناة' },
  { value: 'ربيب', label: '👦 ربيب' },
  { value: 'ربيبة', label: '👧 ربيبة' }
];
...
export default function Family() {
  ...
  useEffect(() => {
    ...
    const relationPriority = {
      ...
      'قريب': 14, 'قريبة': 14,
      'متبنى': 15, 'متبناة': 15, 'ربيب': 15, 'ربيبة': 15
    };
